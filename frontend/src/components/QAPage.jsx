...
function QAPage() {
  ...
  const handleGenerateQA = async () => {
    setLoading(true);
    try {
      const res = await axios.post("http://localhost:5000/generate-qa", {
        text,
        num_questions: 5,
      });
  ...
  return (
    <div className="qa-page">
      <h2>Generate Question & Answer Pairs</h2>
      {/* <textarea
        rows="10"
      ...
      <div class="relative w-full min-w-[200px]">
        <textarea
          ...
          ></textarea>
        <label
          class="before:content[' '] after:content[' '] pointer-events-none 
      ...
      <button  onClick={handleGenerateQA} disabled={loading} type="button" className="text-white 
      ...
      {qaPairs.length > 0 && (
        <div className="qa-section text-xl">
